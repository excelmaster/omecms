...
<body class="hold-transition sidebar-mini layout-footer-fixed" style="background-image: url(<?php echo base_url('public/img/kids/template/bcg_template.jpg'); ?>);height: auto;">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" data-widget="pushmenu" href="#" role="button">
            <img src="<?php echo base_url('public/img/kids/template/sidebar_menu.gif'); ?>" style="width: 1.5cm; height: 1cm; "></a>
          </a>
        </li>
      </ul>
        ...
        <div class="row float-left">
          <div class="col sm-6">
            <a class="button" onclick="sonido()" style="width: 100px;">
              <img src="<?php echo base_url('public/img/kids/template/footer_no_volume.PNG'); ?>" id="volume" class="img-thumbnail img-fluid" style="width: 70px; height: 70px;  ">
            </a>
          </div>
          <div class="col sm-3">
            <audio id="myAudio" controls autoplay preload="auto" allow="autoplay">
              <source src="<?php echo base_url('public/sound/kids/sound_body_rdc.mp3'); ?>" type="audio/mpeg">
              Your browser does not support the audio element.
            </audio><br>
          </div>
          <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">
            <img src="<?php echo base_url('public/img/kids/template/footer_selector.gif'); ?>" class="img-thumbnail img-circle" style="width: 50px; height: 50px;" alt="">
          </a>
        </div>
      </div>

      <button class="openbtn" onclick="openNav()">
        <img src="<?php echo base_url('public/img/kids/template/footer_selector.gif'); ?>" class="img-thumbnail img-circle" style="width: 50px; height: 50px; ">
      </button>
    </footer>
  ...
  <script>
    ...
    function sonido() {
      if (myAudio.paused) {
        icono.setAttribute("src", "<?php echo base_url('public/img/kids/template/no_volume.PNG'); ?>");
        myAudio.play();
        myAudio.loop = true;
      } else {
        icono.setAttribute("src", "<?php echo base_url('public/img/kids/template/volume.PNG'); ?>");
        myAudio.pause();
      }
    }
